...
Route::get('drug-generatepdf', [DrugController::class, 'generatepdf'])->name('drug.pdf');
//upload atau import
Route::post('drug-import', [DrugController::class, 'import'])->name('drug.import');
//export excel
Route::get('drug-export', [DrugController::class, 'export'])->name('drug.export');

Route::get('formupload', [UploadController::class, 'index'])->name('formupload.drug');
Route::post('upload', [UploadController::class, 'upload'])->name('upload.drug');
